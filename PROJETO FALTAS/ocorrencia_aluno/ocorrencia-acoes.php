...
if (isset($_POST['create_ocorrencia'])) {
    ...
    if (empty($tipo_ocorrencia) || empty($id_aluno) || empty($data) || empty($descricao) || empty($justificativa)) {
    ...
    $sql = "INSERT INTO ocorrencia (tipo_ocorrencia, id_aluno, data_oco, descricao, justificativa) 
            VALUES (:tipo_ocorrencia, :id_aluno, :data_oco, :descricao, :justificativa)";
...
if (isset($_POST['update_ocorrencia'])) {
    ...
    // Validação dos campos obrigatórios
    if (empty($tipo_ocorrencia) || empty($id_aluno) || empty($data_oco) || empty($descricao) || empty($justificativa)) {
