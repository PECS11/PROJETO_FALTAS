        ...
        <div class="col-md-12">
            <div class="card">
              ...
              if (isset($_GET['id']) && is_numeric($_GET['id'])) {
                  ...
                  // Consulta para buscar dados da ocorrência e do funcionário
                  $sql = "SELECT ocorrencia.*, funcionario.nome AS funcionario_nome
                          FROM ocorrencia
                  ...
                  try {
                      ...
                      if ($stmt->rowCount() > 0) {
                          ...
                          <div class="mb-3">
                            ...
                            <p class="form-control"><?= htmlspecialchars($ocorrencia['funcionario_nome'] ?? 'Não encontrado'); ?></p>
                          </div>
                          <div class="mb-3">
